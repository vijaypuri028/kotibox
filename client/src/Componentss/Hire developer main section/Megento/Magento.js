...
export default function Magento() {
  ...
  const Secondtext = { Text: "Our knowledge at MindInventory is that a  development team is its most important asset. Engage with our team of passionate magento developers to transform your  idea into a flawless, user-friendly solution. We have a wealth of expertise handling these projects. " }
  ...
  <Navbar/>
    ...
    <Hirecardsection
        imgSrc={imgSrc5}
        mainText1="Why Hire magento  Developer from Kotibox ?"
        mainTextp="At Kotibox Global Technologies, we work with business owners of all sizes who operate in diverse industry verticals. We are aware of how critical it is for the company to expand in several areas. As a result, we produce excellent magento app development work that meets perceptibility and return on investment objectives.
             In relation to magento , we have effectively provided  in a number of categories, including e-commerce, gaming, enterprise, restaurant ordering, utility, and many more, all at a reasonable cost.Kotiboxis a clear choice for developers with outstanding delivery and ethics when clients often look to Hire Dedicated Developers."
        sectionHeading="Advantages of Employing a Skilled magento  Developer"
        sectionDescription="Because of its Linux-based free and open-source platform, magento applications are widely used. Kotibox Global Technologies, an innovative magento application development business, offers an end-to-end open-source solution in this manner. The acknowledgment of magento application development gained momentum following Google's announcement, which raised awareness of magento smartphones globally."
        imgSrc1={imgSrc1}
        cardTitle1="Focused Team"
        cardDescription1=" Hire committed magento  developers from TekRevol. Our group can help develop applications that are both user-friendly and perform well."
        imgSrc2={imgSrc2}
        ...
        cardDescription3="Without compromising on quality, we can finish the magento  development process at a reasonable price."
        ...
        sectionHeading2="Hire Dedicated magento Application Developer As Per Your Needs"
        sectionpra="At Kotibox Global Technologies, we work with business owners of all sizes who operate in diverse industry verticals. We are aware of how critical it is for the company to expand in several areas. As a result, we produce excellent magento  development work that meets perceptibility and return on investment objectives.
             In relation to magento , we have effectively provided  in a number of categories, including e-commerce, gaming, enterprise, restaurant ordering, utility, and many more, all at a reasonable cost.Kotiboxis a clear choice for developers with outstanding delivery and ethics when clients often look to Hire Dedicated Developers"
        Industriesheading="Hire magento  Developers for various Industries"
        Industriesp="Our skilled group of magento developers is dedicated to creating unique solutions that are tailored to the unique requirements of your company. We have the expertise to bring your ideas to life, whether you're a startup firm trying to make a name for itself or an established organization looking to innovate."


         accordionheading="How Is the Magento Development Process at Kotibox Operational?"
