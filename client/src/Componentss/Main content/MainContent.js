...
function MainContent({
  ...
  <div>
    ...
    <div style={{width:"80%", marginLeft:"150px" }} className='d-flex justify-content-between  mt-5  '>
    <h2 className='w-25'  >One-Stop Solution for
    Multiple Offers </h2> 
    <h5 className='w-50' >{circeltext}</h5>
...
<section className="services section-bg" id="services">
    ...
    <div className="container">
      <header className="section-header">
        ...
        <p>Proven by our years of experience, we are all about delivering excellence across industries—from foods and beverages to retail and beyond.</p>
      </header>
      <div className="row">
          ...
          <div  className="col-md-6 col-lg-4">
            <div className="box">
              <div className="icon" style={{ background: '#fff' }}>
              <img style={{height:"50px",width:"50px"}} src={Education} alt='' />
              </div>
              <h3 className="title">Education & E-learning</h3>
              <p style={{ fontSize: "18px" }} className="description"></p>
            </div>
          </div>
          <div  className="col-md-6 col-lg-4">
            <div className="box">
              <div className="icon" style={{ background: '#fff' }}>
              <img style={{height:"50px",width:"50px"}} src={Food} alt='' />
              </div>
          ...
          <div  className="col-md-6 col-lg-4">
            <div className="box">
              <div className="icon" style={{ background: '#fff' }}>
              <img style={{height:"50px",width:"50px"}} src={Gaming} alt='' />
              </div>
          ...
          <div  className="col-md-6 col-lg-4">
            <div className="box">
              <div className="icon" style={{ background: '#fff' }}>
              <img style={{height:"50px",width:"50px"}} src={Tour} alt='' />
              </div>
          ...
          <div  className="col-md-6 col-lg-4">
            <div className="box">
              <div className="icon" style={{ background: '#fff' }}>
              <img style={{height:"50px",width:"50px"}} src={Banking} alt='' />
              </div>
          ...
          <div  className="col-md-6 col-lg-4">
            <div className="box">
              <div className="icon" style={{ background: '#fff' }}>
              <img style={{height:"50px",width:"50px"}} src={Media} alt='' />
              </div>
          ...
          <div  className="col-md-6 col-lg-4">
            <div className="box">
              <div className="icon" style={{ background: '#fff' }}>
              <img style={{height:"50px",width:"50px"}} src={Healthcare} alt='' />
              </div>
          ...
          <div  className="col-md-6 col-lg-4">
            <div className="box">
              <div className="icon" style={{ background: '#fff' }}>
              <img style={{height:"60px",width:"60px"}} src={RealEstate} alt='' />
              </div>
           ...
           <div  className="col-md-6 col-lg-4">
            <div className="box">
              ...
              <img style={{height:"50px",width:"60px"}} src={ECommerce} alt='' />
              </div>
